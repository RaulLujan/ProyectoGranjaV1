...
public class StyleFactory {
    ...
    public static final Color DARK_GREY_BLUE_COLOR = new Color(0,0.8f,0.8f,1);
    ...
    public static TextButtonStyle getStyle(Color colorUp, Color colorDown) {
        ...
        TextButtonStyle textButtonStyle = new TextButtonStyle(bgDrawbleUp, bgDrawbleDown, bgDrawbleUp, new BitmapFont());
